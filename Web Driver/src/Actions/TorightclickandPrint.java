...
public class TorightclickandPrint {
...
List<WebElement> rightClickOption = driver.findElements(By.xpath("js-list list-wrapper"));
for(WebElement ele:rightClickOption) {
